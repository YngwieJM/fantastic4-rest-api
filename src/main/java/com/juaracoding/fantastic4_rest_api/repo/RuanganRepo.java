...
public interface RuanganRepo extends JpaRepository<Ruangan, Long> {

    public Page<Ruangan> findByNamaRuanganContainsIgnoreCase(String nama, Pageable pageable);
    public Page<Ruangan> findByKapasitasBetween(Short minKapasitas, Short maxKapasitas, Pageable pageable);
    public List<Ruangan> findByLokasiContainsIgnoreCase(String lokasi, Pageable pageable);

    public List<Ruangan> findByNamaRuanganContainsIgnoreCase(String nama);
    public List<Ruangan> findByKapasitasBetween(Short minKapasitas, Short maxKapasitas);
